...
const Login = props => {
  ...
  return (<div className="main-container">
    ...
    <form className="user-input" onSubmit={login}>
      {
        !hasAccount && <div>
            <label className="item" htmlFor="first-name">First Name:</label>
            <input type="text" name="first-name" onChange={e => setFirstName(e.target.value)}></input>
            <label className="item" htmlFor="last-name">Last Name:</label>
            <input type="text" name="last-name" onChange={e => setLastName(e.target.value)}></input>
          </div>
      }
      <label className="item" htmlFor="username">Username:</label>
      <input type="text" onChange={e => setUsername(e.target.value)}></input>
      <label className="item" htmlFor="password">Password:</label>
      <input type="password" name="password" onChange={e => setPassword(e.target.value)}></input>
      {
        !hasAccount && <div>
            <label className="item" htmlFor="password">Confirm Password:</label>
            <input type="password" name="password" onChange={e => checkPasswords(e.target.value)}></input>
          </div>
      }
      <p>{err}</p>
